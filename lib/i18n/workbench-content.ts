...
export const WORKBENCH_UI: Record<Locale, WorkbenchUIStrings> = {
  en: {
    ...
    pageSubtitle:
      "Pin the tools you use most, arrange them side by side, and switch between named setups — your own toolbox, on one page.",
    newWorkspace: "+ New workspace",
    addTool: "+ Add tool",
    emptyTitle: "This workspace is empty",
    emptyBody: "Add the tools you use most — once you have a few, drag cards to reorder them.",
  ...
  ru: {
    ...
    pageSubtitle:
      "Закрепи инструменты, которыми пользуешься чаще всего, расположи их рядом и переключайся между именованными наборами — свой тулбокс на одной странице.",
    newWorkspace: "+ Новое пространство",
    addTool: "+ Добавить инструмент",
    emptyTitle: "Это пространство пустое",
    emptyBody: "Добавь инструменты, которыми пользуешься чаще всего — когда их станет несколько, карточки можно перетаскивать местами.",
    ...
    dragHandleTitle: "Перетащите, чтобы изменить порядок",

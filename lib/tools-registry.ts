...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    category: "web", isImplemented: true, isPopular: true,
  ...
  },
  {
    ...
    relatedSlugs: ["curl-generator", "header-inspector", "rest-request-builder", "json-mutator"],
  ...
  },
  {
    ...
    longDescription: "Paste your JSON body from Postman or Swagger, select a field, and instantly get dozens of mutated variants — wrong types, boundary values, injection payloads — ready to copy and test.",
    metaDescription: "Free JSON mutator for API negative testing. Generate type mutations, boundary values and injection payloads from any JSON body. Perfect for QA engineers.",
    category: "qa", isImplemented: true, isPopular: true, isFeatured: true,
    aliases: ["json type mutator", "api negative testing", "payload mutator", "fuzz testing"],
    relatedSlugs: ["api-request-builder", "boundary-value-generator", "test-case-generator"],
    keywords: ["json mutator", "api negative testing", "payload fuzzing", "boundary value testing", "type mutation"],
  },
  {
